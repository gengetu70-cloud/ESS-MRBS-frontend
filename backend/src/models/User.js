...
const UserSchema = new mongoose.Schema(
  {
    ...
    fullName: {
      ...
      set: function(value) {
        // FIXED: Removed extra comma and used proper trim
    ...
    email: {
      ...
      required: false,
      unique: true,
      sparse: true, // ✅ This is correct - allows multiple null values
      trim: true,
      lowercase: true,
      // FIXED: Only validate if email is provided
      validate: {
        validator: function(value) {
          // If email is empty, null, or undefined, skip validation
