    ...
    <>
      ...
      <Box sx={{ 
        ...
        >
              ...
              <Box sx={{ 
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1.5, sm: 2 } }}>
                  ...
                  <Box>
                    ...
                    >
                      Book meeting rooms and manage your schedule
                    </Typography>
                  </Box>
                </Box>
                <Tooltip title="Refresh Dashboard">
                  ...
                  >
                    <RefreshIcon sx={{ fontSize: { xs: 18, sm: 22 }, animation: refreshing ? 'spin 1s linear infinite' : 'none' }} />
                  </IconButton>
                </Tooltip>
              </Box>
            </Paper>
          ...
          <Grid container spacing={{ xs: 1, sm: 1.5, md: 2 }} sx={{ mb: { xs: 1.5, sm: 2, md: 2.5 } }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1.5, sm: 2 }, width: '100%' }}>
                      ...
                      <Box sx={{ flex: 1 }}>
                        <Typography 
                          ...
                          fontWeight="bold" 
                          color={stat.color}
                          sx={{ fontSize: { xs: '1.2rem', sm: '1.4rem', md: '1.8rem' }, lineHeight: 1.2 }}
                        >
                          {stat.value}
                        </Typography>
                        <Typography 
