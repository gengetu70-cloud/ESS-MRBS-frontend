              ...
              <Box textAlign="center">
                ...
                >
                  <Typography
                    ...
                    fontWeight="600"
                    sx={{
                      fontSize: { xs: '1.2rem', md: '2.8rem', lg: '3.5rem' },
                      mb: 2,
                      lineHeight: 1.1,
                ...
                >
                  ...
                  >
                    Book, manage, schedule, and optimize meeting spaces with an intelligent
                    enterprise-grade reservation platform.
                  </Typography>
                </motion.div>
        ...
        <Container maxWidth="lg" sx={{ mt: -4, position: 'relative', zIndex: 2 }}>
          <Grid container spacing={6}>
            {[
              ...
              { icon: <People />, value: 24, label: 'Active Users', color: '#9c27b0' },
            ].map((stat, i) => (
        ...
        >
          <Container maxWidth="md">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Typography variant="h5" fontWeight="400" sx={{ mb: 3 }}>
                Ready to Modernize Your Booking?
              </Typography>
              {/* Only show Get Started button if NOT authenticated */}
              {!isAuthenticated && (
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    variant="contained"
